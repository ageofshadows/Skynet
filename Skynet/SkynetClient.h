...
#pragma once
#ifndef skynetcppclient_h__INCLUDED
#define skynetcppclient_h__INCLUDED
...
//! [ewrapperimpl]
class SkynetEWrapper : public EWrapper
{
	//! [ewrapperimpl]
public:
...
private:
	...
	void tickDataOperation(std::vector<TickerId>, std::vector<Contract>);
...
private:
	FILE * pFile;
	boost::shared_ptr<SkynetAlgorithm> skynetAlgo_;

	const time_t t;
	struct tm* current_time;
	int current_min, last_min;
