...
const int SLEEP_BETWEEN_PINGS = 30; // seconds
									...
									// member funcs
									//! [socket_init]
InteractiveBrokersCppClient::InteractiveBrokersCppClient() :
...
bool InteractiveBrokersCppClient::connect(const char *host, unsigned int port, int clientId)
{
	// trying to connect
...
void InteractiveBrokersCppClient::disconnect() const
{
...
bool InteractiveBrokersCppClient::isConnected() const
{
	return m_pClient->isConnected();
}

void InteractiveBrokersCppClient::setConnectOptions(const std::string& connectOptions)
{
	m_pClient->setConnectOptions(connectOptions);
}

void InteractiveBrokersCppClient::processMessages() {
...
// methods
//! [connectack]
void InteractiveBrokersCppClient::connectAck() {
	if (!m_extraAuth && m_pClient->asyncEConnect())
		m_pClient->startApi();
}
//! [connectack]

void InteractiveBrokersCppClient::reqCurrentTime()
{
...
void InteractiveBrokersCppClient::tickDataOperation()
{
...
void InteractiveBrokersCppClient::marketDepthOperations()
{
...
void InteractiveBrokersCppClient::realTimeBars()
{
...
void InteractiveBrokersCppClient::marketDataType()
{
	//! [reqmarketdatatype]
...
void InteractiveBrokersCppClient::historicalDataRequests()
{
...
void InteractiveBrokersCppClient::optionsOperations()
{
	//! [reqsecdefoptparams]
...
void InteractiveBrokersCppClient::contractOperations()
{
...
void InteractiveBrokersCppClient::marketScanners()
{
...
void InteractiveBrokersCppClient::reutersFundamentals()
{
...
void InteractiveBrokersCppClient::bulletins()
{
...
void InteractiveBrokersCppClient::accountOperations()
{
...
void InteractiveBrokersCppClient::orderOperations()
{
...
void InteractiveBrokersCppClient::ocaSamples()
{
	//OCA ORDER
	//! [ocasubmit]
...
void InteractiveBrokersCppClient::conditionSamples()
{
...
void InteractiveBrokersCppClient::bracketSample() {
	Order parent;
	Order takeProfit;
	Order stopLoss;
	//! [bracketsubmit]
...
void InteractiveBrokersCppClient::hedgeSample() {
	//F Hedge order
	//! [hedgesubmit]
...
void InteractiveBrokersCppClient::testAlgoSamples() {
	//! [algo_base_order]
...
void InteractiveBrokersCppClient::financialAdvisorOrderSamples()
{
	//! [faorderoneaccount]
...
void InteractiveBrokersCppClient::financialAdvisorOperations()
{
...
void InteractiveBrokersCppClient::testDisplayGroups() {
	//! [querydisplaygroups]
...
void InteractiveBrokersCppClient::miscelaneous()
{
...
//! [nextvalidid]
void InteractiveBrokersCppClient::nextValidId(OrderId orderId)
{
...
void InteractiveBrokersCppClient::currentTime(long time)
{
...
//! [error]
void InteractiveBrokersCppClient::error(const int id, const int errorCode, const std::string errorString)
{
...
//! [tickprice]
void InteractiveBrokersCppClient::tickPrice(TickerId tickerId, TickType field, double price, int canAutoExecute) {
	printf("Tick Price. Ticker Id: %ld, Field: %d, Price: %g, CanAutoExecute: %d\n", tickerId, (int)field, price, canAutoExecute);
}
//! [tickprice]

//! [ticksize]
void InteractiveBrokersCppClient::tickSize(TickerId tickerId, TickType field, int size) {
	printf("Tick Size. Ticker Id: %ld, Field: %d, Size: %d\n", tickerId, (int)field, size);
}
//! [ticksize]

//! [tickoptioncomputation]
void InteractiveBrokersCppClient::tickOptionComputation(TickerId tickerId, TickType tickType, double impliedVol, double delta,
...
//! [tickgeneric]
void InteractiveBrokersCppClient::tickGeneric(TickerId tickerId, TickType tickType, double value) {
	printf("Tick Generic. Ticker Id: %ld, Type: %d, Value: %g\n", tickerId, (int)tickType, value);
}
//! [tickgeneric]

//! [tickstring]
void InteractiveBrokersCppClient::tickString(TickerId tickerId, TickType tickType, const std::string& value) {
	printf("Tick String. Ticker Id: %ld, Type: %d, Value: %s\n", tickerId, (int)tickType, value.c_str());
}
//! [tickstring]

void InteractiveBrokersCppClient::tickEFP(TickerId tickerId, TickType tickType, double basisPoints, const std::string& formattedBasisPoints,
...
//! [orderstatus]
void InteractiveBrokersCppClient::orderStatus(OrderId orderId, const std::string& status, double filled,
...
//! [openorder]
void InteractiveBrokersCppClient::openOrder(OrderId orderId, const Contract& contract, const Order& order, const OrderState& ostate) {
...
//! [openorderend]
void InteractiveBrokersCppClient::openOrderEnd() {
	printf("OpenOrderEnd\n");
}
//! [openorderend]

void InteractiveBrokersCppClient::winError(const std::string& str, int lastError) {}
void InteractiveBrokersCppClient::connectionClosed() {
	printf("Connection Closed\n");
}

//! [updateaccountvalue]
void InteractiveBrokersCppClient::updateAccountValue(const std::string& key, const std::string& val,
...
//! [updateportfolio]
void InteractiveBrokersCppClient::updatePortfolio(const Contract& contract, double position,
...
//! [updateaccounttime]
void InteractiveBrokersCppClient::updateAccountTime(const std::string& timeStamp) {
	printf("UpdateAccountTime. Time: %s\n", timeStamp.c_str());
}
//! [updateaccounttime]

//! [accountdownloadend]
void InteractiveBrokersCppClient::accountDownloadEnd(const std::string& accountName) {
	printf("Account download finished: %s\n", accountName.c_str());
}
//! [accountdownloadend]

//! [contractdetails]
void InteractiveBrokersCppClient::contractDetails(int reqId, const ContractDetails& contractDetails) {
...
void InteractiveBrokersCppClient::bondContractDetails(int reqId, const ContractDetails& contractDetails) {
...
//! [contractdetailsend]
void InteractiveBrokersCppClient::contractDetailsEnd(int reqId) {
	printf("ContractDetailsEnd. %d\n", reqId);
}
//! [contractdetailsend]

//! [execdetails]
void InteractiveBrokersCppClient::execDetails(int reqId, const Contract& contract, const Execution& execution) {
...
//! [execdetailsend]
void InteractiveBrokersCppClient::execDetailsEnd(int reqId) {
	printf("ExecDetailsEnd. %d\n", reqId);
}
//! [execdetailsend]

//! [updatemktdepth]
void InteractiveBrokersCppClient::updateMktDepth(TickerId id, int position, int operation, int side,
	double price, int size) {
	printf("UpdateMarketDepth. %ld - Position: %d, Operation: %d, Side: %d, Price: %g, Size: %d\n", id, position, operation, side, price, size);
}
//! [updatemktdepth]

void InteractiveBrokersCppClient::updateMktDepthL2(TickerId id, int position, std::string marketMaker, int operation,
	int side, double price, int size) {
	printf("UpdateMarketDepthL2. %ld - Position: %d, Operation: %d, Side: %d, Price: %g, Size: %d\n", id, position, operation, side, price, size);
}

//! [updatenewsbulletin]
void InteractiveBrokersCppClient::updateNewsBulletin(int msgId, int msgType, const std::string& newsMessage, const std::string& originExch) {
	printf("News Bulletins. %d - Type: %d, Message: %s, Exchange of Origin: %s\n", msgId, msgType, newsMessage.c_str(), originExch.c_str());
}
//! [updatenewsbulletin]

//! [managedaccounts]
void InteractiveBrokersCppClient::managedAccounts(const std::string& accountsList) {
	printf("Account List: %s\n", accountsList.c_str());
}
//! [managedaccounts]

//! [receivefa]
void InteractiveBrokersCppClient::receiveFA(faDataType pFaDataType, const std::string& cxml) {
	std::cout << "Receiving FA: " << (int)pFaDataType << std::endl << cxml << std::endl;
}
//! [receivefa]

//! [historicaldata]
void InteractiveBrokersCppClient::historicalData(TickerId reqId, const std::string& date, double open, double high,
...
//! [scannerparameters]
void InteractiveBrokersCppClient::scannerParameters(const std::string& xml) {
	printf("ScannerParameters. %s\n", xml.c_str());
}
//! [scannerparameters]

//! [scannerdata]
void InteractiveBrokersCppClient::scannerData(int reqId, int rank, const ContractDetails& contractDetails,
...
//! [scannerdataend]
void InteractiveBrokersCppClient::scannerDataEnd(int reqId) {
	printf("ScannerDataEnd. %d\n", reqId);
}
//! [scannerdataend]

//! [realtimebar]
void InteractiveBrokersCppClient::realtimeBar(TickerId reqId, long time, double open, double high, double low, double close,
...
//! [fundamentaldata]
void InteractiveBrokersCppClient::fundamentalData(TickerId reqId, const std::string& data) {
	printf("FundamentalData. ReqId: %ld, %s\n", reqId, data.c_str());
}
//! [fundamentaldata]

void InteractiveBrokersCppClient::deltaNeutralValidation(int reqId, const UnderComp& underComp) {
	printf("DeltaNeutralValidation. %d, ConId: %ld, Delta: %g, Price: %g\n", reqId, underComp.conId, underComp.delta, underComp.price);
}

//! [ticksnapshotend]
void InteractiveBrokersCppClient::tickSnapshotEnd(int reqId) {
	printf("TickSnapshotEnd: %d\n", reqId);
}
//! [ticksnapshotend]

//! [marketdatatype]
void InteractiveBrokersCppClient::marketDataType(TickerId reqId, int marketDataType) {
	printf("MarketDataType. ReqId: %ld, Type: %d\n", reqId, marketDataType);
}
//! [marketdatatype]

//! [commissionreport]
void InteractiveBrokersCppClient::commissionReport(const CommissionReport& commissionReport) {
...
//! [position]
void InteractiveBrokersCppClient::position(const std::string& account, const Contract& contract, double position, double avgCost) {
...
//! [positionend]
void InteractiveBrokersCppClient::positionEnd() {
	printf("PositionEnd\n");
}
//! [positionend]

//! [accountsummary]
void InteractiveBrokersCppClient::accountSummary(int reqId, const std::string& account, const std::string& tag, const std::string& value, const std::string& currency) {
	printf("Acct Summary. ReqId: %d, Account: %s, Tag: %s, Value: %s, Currency: %s\n", reqId, account.c_str(), tag.c_str(), value.c_str(), currency.c_str());
}
//! [accountsummary]

//! [accountsummaryend]
void InteractiveBrokersCppClient::accountSummaryEnd(int reqId) {
	printf("AccountSummaryEnd. Req Id: %d\n", reqId);
}
//! [accountsummaryend]

void InteractiveBrokersCppClient::verifyMessageAPI(const std::string& apiData) {
	printf("verifyMessageAPI: %s\b", apiData.c_str());
}

void InteractiveBrokersCppClient::verifyCompleted(bool isSuccessful, const std::string& errorText) {
	printf("verifyCompleted. IsSuccessfule: %d - Error: %s\n", isSuccessful, errorText.c_str());
}

void InteractiveBrokersCppClient::verifyAndAuthMessageAPI(const std::string& apiDatai, const std::string& xyzChallenge) {
	printf("verifyAndAuthMessageAPI: %s %s\n", apiDatai.c_str(), xyzChallenge.c_str());
}

void InteractiveBrokersCppClient::verifyAndAuthCompleted(bool isSuccessful, const std::string& errorText) {
...
//! [displaygrouplist]
void InteractiveBrokersCppClient::displayGroupList(int reqId, const std::string& groups) {
	printf("Display Group List. ReqId: %d, Groups: %s\n", reqId, groups.c_str());
}
//! [displaygrouplist]

//! [displaygroupupdated]
void InteractiveBrokersCppClient::displayGroupUpdated(int reqId, const std::string& contractInfo) {
	std::cout << "Display Group Updated. ReqId: " << reqId << ", Contract Info: " << contractInfo << std::endl;
}
//! [displaygroupupdated]

//! [positionmulti]
void InteractiveBrokersCppClient::positionMulti(int reqId, const std::string& account, const std::string& modelCode, const Contract& contract, double pos, double avgCost) {
...
//! [positionmultiend]
void InteractiveBrokersCppClient::positionMultiEnd(int reqId) {
	printf("Position Multi End. Request: %d\n", reqId);
}
//! [positionmultiend]

//! [accountupdatemulti]
void InteractiveBrokersCppClient::accountUpdateMulti(int reqId, const std::string& account, const std::string& modelCode, const std::string& key, const std::string& value, const std::string& currency) {
...
void InteractiveBrokersCppClient::accountUpdateMultiEnd(int reqId) {
	printf("Account Update Multi End. Request: %d\n", reqId);
}
//! [accountupdatemultiend]

//! [securityDefinitionOptionParameter]
void InteractiveBrokersCppClient::securityDefinitionOptionalParameter(int reqId, const std::string& exchange, int underlyingConId, const std::string& tradingClass, const std::string& multiplier, std::set<std::string> expirations, std::set<double> strikes) {
...
void InteractiveBrokersCppClient::securityDefinitionOptionalParameterEnd(int reqId) {
	printf("Security Definition Optional Parameter End. Request: %d\n", reqId);
}
//! [securityDefinitionOptionParameterEnd]

//! [softDollarTiers]
void InteractiveBrokersCppClient::softDollarTiers(int reqId, const std::vector<SoftDollarTier> &tiers) {
